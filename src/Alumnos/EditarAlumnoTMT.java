...
public class EditarAlumnoTMT extends javax.swing.JFrame {


    public EditarAlumnoTMT() {
        initComponents();
    }
    EditarTMT edit = new EditarTMT();
    ...
    private void initComponents() {
        ...
        jTabbedPane2.addTab("1 \"A\"", jPanel3);
        ...
        jTabbedPane2.addTab("2 \"A\"", jPanel4);
        ...
        jTabbedPane2.addTab("3 \"A\"", jPanel5);
        ...
        jTabbedPane2.addTab("4 \"A\"", jPanel6);
        ...
        jTabbedPane2.addTab("5 \"A\"", jPanel7);
        ...
        jTabbedPane2.addTab("1 \"B\"", jPanel9);
        ...
        jTabbedPane2.addTab("2 \"B\"", jPanel10);
        ...
        jTabbedPane2.addTab("3 \"B\"", jPanel11);
        ...
        jTabbedPane2.addTab("4 \"B\"", jPanel12);
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPane13, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 708, Short.MAX_VALUE)
                    .addGroup(jPanel13Layout.createSequentialGroup()
        ...
        jTabbedPane2.addTab("5 \"B\"", jPanel13);
    ...
    private void jTable3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MousePressed
        ...
        if(fila >=0){
            Matricula1.setText(jTable3.getValueAt(fila, 0).toString());
            password1.setText(jTable3.getValueAt(fila, 1).toString());
            nombre1.setText(jTable3.getValueAt(fila, 2).toString());
            apellido1.setText(jTable3.getValueAt(fila, 3).toString());
            cuatri1.setText(jTable3.getValueAt(fila, 4).toString());
            grupo1.setText(jTable3.getValueAt(fila, 5).toString());
            modalidad1.setText(jTable3.getValueAt(fila, 6).toString());
            turno1.setText(jTable3.getValueAt(fila, 7).toString());
            cod1.setText(jTable3.getValueAt(fila, 0).toString());
        }else{
            cod1.setText("ID");
        }
    ...
    private void jTable4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable4MousePressed
        ...
        if(fila >=0){
            Matricula2.setText(jTable4.getValueAt(fila, 0).toString());
            password2.setText(jTable4.getValueAt(fila, 1).toString());
            nombre2.setText(jTable4.getValueAt(fila, 2).toString());
            apellido2.setText(jTable4.getValueAt(fila, 3).toString());
            cuatri2.setText(jTable4.getValueAt(fila, 4).toString());
            grupo2.setText(jTable4.getValueAt(fila, 5).toString());
            modalidad2.setText(jTable4.getValueAt(fila, 6).toString());
            turno2.setText(jTable4.getValueAt(fila, 7).toString());
            cod2.setText(jTable4.getValueAt(fila, 0).toString());
        }else{
            cod2.setText("ID");
        }
    ...
    private void jTable5MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable5MousePressed
        ...
        if(fila >=0){
            Matricula3.setText(jTable5.getValueAt(fila, 0).toString());
            password3.setText(jTable5.getValueAt(fila, 1).toString());
            nombre3.setText(jTable5.getValueAt(fila, 2).toString());
            apellido3.setText(jTable5.getValueAt(fila, 3).toString());
            cuatri3.setText(jTable5.getValueAt(fila, 4).toString());
            grupo3.setText(jTable5.getValueAt(fila, 5).toString());
            modalidad3.setText(jTable5.getValueAt(fila, 6).toString());
            turno3.setText(jTable5.getValueAt(fila, 7).toString());
            cod3.setText(jTable5.getValueAt(fila, 0).toString());
        }else{
            cod3.setText("ID");
        }
    ...
    private void jTable6MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable6MousePressed
        ...
        if(fila >=0){
            Matricula4.setText(jTable6.getValueAt(fila, 0).toString());
            password4.setText(jTable6.getValueAt(fila, 1).toString());
            nombre4.setText(jTable6.getValueAt(fila, 2).toString());
            apellido4.setText(jTable6.getValueAt(fila, 3).toString());
            cuatri4.setText(jTable6.getValueAt(fila, 4).toString());
            grupo4.setText(jTable6.getValueAt(fila, 5).toString());
            modalidad4.setText(jTable6.getValueAt(fila, 6).toString());
            turno4.setText(jTable6.getValueAt(fila, 7).toString());
            cod4.setText(jTable6.getValueAt(fila, 0).toString());
        }else{
            cod4.setText("ID");
        }
    ...
    private void jTable7MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable7MousePressed
        ...
        if(fila >=0){
            Matricula5.setText(jTable7.getValueAt(fila, 0).toString());
            password5.setText(jTable7.getValueAt(fila, 1).toString());
            nombre5.setText(jTable7.getValueAt(fila, 2).toString());
            apellido5.setText(jTable7.getValueAt(fila, 3).toString());
            cuatri5.setText(jTable7.getValueAt(fila, 4).toString());
            grupo5.setText(jTable7.getValueAt(fila, 5).toString());
            modalidad5.setText(jTable7.getValueAt(fila, 6).toString());
            turno5.setText(jTable7.getValueAt(fila, 7).toString());
            cod5.setText(jTable7.getValueAt(fila, 0).toString());
        }else{
            cod5.setText("ID");
        }
    ...
    private void jTable9MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable9MousePressed
        ...
        if(fila >=0){
            Matricula7.setText(jTable9.getValueAt(fila, 0).toString());
            password7.setText(jTable9.getValueAt(fila, 1).toString());
            nombre7.setText(jTable9.getValueAt(fila, 2).toString());
            apellido7.setText(jTable9.getValueAt(fila, 3).toString());
            cuatri7.setText(jTable9.getValueAt(fila, 4).toString());
            grupo7.setText(jTable9.getValueAt(fila, 5).toString());
            modalidad7.setText(jTable9.getValueAt(fila, 6).toString());
            turno7.setText(jTable9.getValueAt(fila, 7).toString());
            cod7.setText(jTable9.getValueAt(fila, 0).toString());
        }else{
            cod7.setText("ID");
        }
    ...
    private void jTable10MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable10MousePressed
        ...
        if(fila >=0){
            Matricula8.setText(jTable10.getValueAt(fila, 0).toString());
            password8.setText(jTable10.getValueAt(fila, 1).toString());
            nombre8.setText(jTable10.getValueAt(fila, 2).toString());
            apellido8.setText(jTable10.getValueAt(fila, 3).toString());
            cuatri8.setText(jTable10.getValueAt(fila, 4).toString());
            grupo8.setText(jTable10.getValueAt(fila, 5).toString());
            modalidad8.setText(jTable10.getValueAt(fila, 6).toString());
            turno8.setText(jTable10.getValueAt(fila, 7).toString());
            cod8.setText(jTable10.getValueAt(fila, 0).toString());
        }else{
            cod8.setText("ID");
        }
    ...
    private void jTable11MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable11MousePressed
        ...
        if(fila >=0){
            Matricula9.setText(jTable11.getValueAt(fila, 0).toString());
            password9.setText(jTable11.getValueAt(fila, 1).toString());
            nombre9.setText(jTable11.getValueAt(fila, 2).toString());
            apellido9.setText(jTable11.getValueAt(fila, 3).toString());
            cuatri9.setText(jTable11.getValueAt(fila, 4).toString());
            grupo9.setText(jTable11.getValueAt(fila, 5).toString());
            modalidad9.setText(jTable11.getValueAt(fila, 6).toString());
            turno9.setText(jTable11.getValueAt(fila, 7).toString());
            cod9.setText(jTable11.getValueAt(fila, 0).toString());
        }else{
            cod9.setText("ID");
        }
    ...
    private void jTable12MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable12MousePressed
        ...
        if(fila >=0){
            Matricula10.setText(jTable12.getValueAt(fila, 0).toString());
            password10.setText(jTable12.getValueAt(fila, 1).toString());
            nombre10.setText(jTable12.getValueAt(fila, 2).toString());
            apellido10.setText(jTable12.getValueAt(fila, 3).toString());
            cuatri10.setText(jTable12.getValueAt(fila, 4).toString());
            grupo10.setText(jTable12.getValueAt(fila, 5).toString());
            modalidad10.setText(jTable12.getValueAt(fila, 6).toString());
            turno10.setText(jTable12.getValueAt(fila, 7).toString());
            cod10.setText(jTable12.getValueAt(fila, 0).toString());
        }else{
            cod10.setText("ID");
        }
    ...
    private void jTable13MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable13MousePressed
        // TODO add your handling code here:
        int fila = jTable13.getSelectedRow();
        if(fila >=0){
            Matricula11.setText(jTable13.getValueAt(fila, 0).toString());
            password11.setText(jTable13.getValueAt(fila, 1).toString());
            nombre11.setText(jTable13.getValueAt(fila, 2).toString());
            apellido11.setText(jTable13.getValueAt(fila, 3).toString());
            cuatri11.setText(jTable13.getValueAt(fila, 4).toString());
            grupo11.setText(jTable13.getValueAt(fila, 5).toString());
            modalidad11.setText(jTable13.getValueAt(fila, 6).toString());
            turno11.setText(jTable13.getValueAt(fila, 7).toString());
            cod11.setText(jTable13.getValueAt(fila, 0).toString());
        }else{
            cod11.setText("ID");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarAlumnoTMT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarAlumnoTMT().setVisible(true);
            }
        });
    }
